...
public class ClonesCollectAllExperiment {
	
	public ClonesCollectAllExperiment() {
...
//		int orderOfMag = 8;
		...
		double waitingTime50th = experiment.getStats().getStat(StatName.WAIT_TIME).getQuantile(.50);
		System.out.println("Waiting 50: " + waitingTime50th);
...
//		this.printQuantileofWaitingTime(experiment);
...
//		experiment.getJobCollector().printAllSample();
	...
	private void printQuantileofWaitingTime(Experiment experiment) {
		for(int i = 1; i < 100; i += 1) {
			double waitingTimeith = experiment.getStats().getStat(StatName.WAIT_TIME).getQuantile(((double) i) / 100);
			System.out.println("Waiting " + i + ": " + waitingTimeith);
		}
	}
	
	public static void main(String[] args) {
		double targetRho = Double.valueOf(args[3]);
		System.out.println("===== Clones Collect All Experiment =====");
		System.out.println("workload: " + args[1]);
		System.out.println("worker numbers: " + args[2]);
		System.out.println("rho: " + targetRho);
		System.out.println("========================================");
		ClonesCollectAllExperiment exp  = new ClonesCollectAllExperiment();
